...
export default function CadastroClientes() {
  ...
  const [name, setName] = useState('');
    ...
    const postData = () => {
        axios.post('https://6355bab6da523ceadc06530d.mockapi.io/api/Clientes', {
          id, 
          name,
          createdBy,
          updatedBy
    ...
    <br></br>
        ...
        <Form.Control type="text" placeholder="name" readOnly={true} onChange={e=> setId(e.target.value)}/>
      </Form.Group>
      <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
        <Form.Label>Email address</Form.Label>
